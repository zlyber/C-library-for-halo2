    ...
    ConcreteCircuit: Circuit<C::Scalar>,
{
    ...
    let l0 = vk.domain.lagrange_to_coeff(l0);//IFFT
    let l0 = vk.domain.coeff_to_extended(l0);//FFT
    ...
    let l_blind = vk.domain.lagrange_to_coeff(l_blind);//IFFT
    let l_blind = vk.domain.coeff_to_extended(l_blind);//FFT
    ...
    let l_last = vk.domain.lagrange_to_coeff(l_last);//IFFT
    let l_last = vk.domain.coeff_to_extended(l_last);//FFT
